...
function goToHomepage() {
  ...
  if (localStorage.getItem("userid")) {
    ...
    // Redirect to the default homepage for users who are not logged in
  ...
  // Function to handle the "View Leaderboard" button click
function viewLeaderboard() {
  // Add your logic here to display the leaderboard
  console.log("View Leaderboard button clicked");
  window.location.href="2048leaderboard.html";
}

// // Function to handle the "Personal Scores" button click
// function viewPersonalScores() {
//   // Add your logic here to display the personal scores
//   console.log("Personal Scores button clicked");
// }



//save highscore
function saveHighscore(userid, gameid, highscore,duration) {
  // Send the highscore, user ID, and game ID to the API
  fetch("/api/2048records/insert", {
    method: "POST",
    headers: {
